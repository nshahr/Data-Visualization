...
a = df.plot(x = 'Date', y=['Other','Hydroelectric', 'Coal', 'Natural Gas', 'Nuclear'], kind="area", color=mycolors[::-1], alpha=0.7)
...
a.legend(reversed(handles), reversed(labels), bbox_to_anchor=(1, 0.7), loc='best', ncol=1)
