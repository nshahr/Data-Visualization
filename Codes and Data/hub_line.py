...
# df.replace(to_replace='_Completed', inplace=True)
mycolors = [
    '#d11141',
    '#00aedb',
    '#f37735',
...
a.legend(bbox_to_anchor=(1, 0.17), loc='best', ncol=1)
...
plt.ylabel("US Dollars per Million Cubic Feet ($/Mcf)",color='black',verticalalignment='bottom',horizontalalignment='left',position=(4,0.8))
